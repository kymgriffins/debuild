              ...
              <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                  {getAllProjects().slice(0, 6).map((project, index) => (
                    <div key={project.id} className="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden">
                      <div className="relative aspect-[4/3] overflow-hidden">
                        ...
                        <div className="absolute top-4 right-4">
                          <Badge className="bg-white/90 text-gray-800 border-0 shadow-sm">
                            {project.category}
                          </Badge>
                        </div>
                      ...
                      <div className="p-6">
                        <div className="space-y-4">
                          ...
                          <a href={`/project/${project.slug}`}>
                            <button className="w-full inline-flex items-center justify-center px-4 py-2 rounded-lg bg-gray-900 text-white font-medium hover:bg-gray-800 transition-all duration-300 text-sm shadow-sm hover:shadow-md">
                              View Project
                            </button>
                          </a>
                        </div>
                ...
                <div className="text-center">
                  <a
                    href="/projects"
                    className="inline-flex items-center justify-center px-8 py-4 rounded-xl bg-gray-900 text-white font-medium hover:bg-gray-800 transition-all duration-300 text-lg shadow-lg hover:shadow-xl"
                  >
                    View All Projects
                  </a>
                </div>
